...
//////////////////////////////////////////////////////////////////////////
  ...
  public CheckErrorsCpp(Compiler compiler)
  {
    super(compiler);  
...
//////////////////////////////////////////////////////////////////////////
  ...
  public void enterType(TypeDef t)
  {
    ...
    if (TranslationUtil.isCppType(curType.qname)) {
      log.info("Skip C++ type " + curType.qname);
      return;
    }
  ...
  private void checkVirtualDtor(TypeDef t) {
    if (TranslationUtil.hasVirtualMethods(t)) {
      if (!TranslationUtil.slotExists(t, instanceDestroyPredicate())) {
        err("Type has virtual methods but no virtual dtor " + t);
      } else {
    ...
    } // else not dtor required
  }

  private TranslationUtil.ISlotSelector instanceDestroyPredicate() {
    return s -> s.isMethod() && ((Method) s).isInstanceDestroy();
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  private void checkFieldFlags(FieldDef f)
  {
    ...
    if (f.isProperty())
    {
      ...
      // ow, 24.09.19: Properties accessed through getter/setter
...
//////////////////////////////////////////////////////////////////////////
  ...
  private void checkMethodFlags(MethodDef m)
  {
    ...
    // C++: Allow inline and const modifiers
...
//////////////////////////////////////////////////////////////////////////
  ...
  private void checkAssignable(Expr expr)
  {
    ...
    {                    
      ...
      if (x.id == Expr.FIELD)
      {
        ...
        if (!f.type().isBuf()) // ow, 25.09.16: Buf is a string in our case an can be assigned
  ...
  private void checkSlotAccess(Slot slot, Location loc, String kind)
  {
    ...
    if (TranslationUtil.isCppType(slot.parent().qname())) {
      return;
    }
    ...
    {
      // ow, 25.09.19: FIXME: Relaxed checks on tests
      /*
      C:\Users\olive\Documents\Development\Sedona\src\sys\test\AppTest.sedona:31:7: Protected field 'sys::App.appName' not accessible in sys::App
      C:\Users\olive\Documents\Development\Sedona\src\sys\test\AppTest.sedona:108:7: Protected field 'sys::App.appName' not accessible in sys::App
      C:\Users\olive\Documents\Development\Sedona\src\sys\test\AppTest.sedona:135:7: Protected field 'sys::App.appName' not accessible in sys::App
      C:\Users\olive\Documents\Development\Sedona\src\sys\test\AppTest.sedona:148:7: Protected field 'sys::App.appName' not accessible in sys::App
      C:\Users\olive\Documents\Development\Sedona\src\sys\test\CompTest.sedona:424:9: Protected field 'sys::Component.watchFlags' not accessible in sys::Component
      C:\Users\olive\Documents\Development\Sedona\src\sys\test\CompTest.sedona:434:16: Protected field 'sys::Component.watchFlags' not accessible in sys::Component
       */
      if (!curType.is(parent) && !TypeUtil.isaTest(curType))
        err("Protected " + kind + " '" + qname + "' not accessible in " + parent, loc);
    }
    else if (slot.isInternal())
    {
      ...
      if (!kit1.equals(kit2))
        err("Internal " + kind + " '" + qname + "' not accessible in " + parent, loc);
    }
...
//////////////////////////////////////////////////////////////////////////
  ...
  private void checkArgs(Expr.Call call)
  {
    ...
    // ow, 27.09.19: + isDestroy
    if (call.method.isInstanceDestroy())
      name = "~" + call.method.parent().name();
