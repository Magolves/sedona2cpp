...
//////////////////////////////////////////////////////////////////////////
    ...
    public void testExpr() {
        ...
        Expr.Name a = (Expr.Name) abc.lhs;
        verifyName(a, "a");
        Expr.Binary bc = (Expr.Binary) abc.rhs;
        Expr.Name b = (Expr.Name) bc.lhs;
        verifyName(b, "b");
        Expr.Name c = (Expr.Name) bc.rhs;
        verifyName(c, "c");
        Expr.Name d = (Expr.Name) abcd.rhs;
        verifyName(d, "d");
        Expr.Binary efg = (Expr.Binary) top.operands.get(1);
        Expr.Name e = (Expr.Name) efg.lhs;
        verifyName(e, "e");
        Expr.Binary fg = (Expr.Binary) efg.rhs;
        Expr.Name f = (Expr.Name) fg.lhs;
        verifyName(f, "f");
        Expr.Name g = (Expr.Name) fg.rhs;
        verifyName(g, "g");
    }
