...
public class PrimitiveDecodeTest
    ...
    public void testShort()
        ...
        ex = null;
        try {
            s = (Short) s.decodeString("0x10000");
        } catch (Exception e) {
            ex = e;
        }
        verify(ex != null);
    ...
    public void testInt()
        ...
        ex = null;
        try {
            i = (Int) i.decodeString("0xfffffffff");
        } catch (Exception e) {
            ex = e;
        }
        verify(ex != null);
        ...
        ex = null;
        try {
            i = (Int) i.decodeString("0x100000000");
        } catch (Exception e) {
            ex = e;
        }
        verify(ex != null);
    ...
    public void testLong()
        ...
        ex = null;
        try {
            l = (Long) l.decodeString("0xfffffffffffffffff");
        } catch (Exception e) {
            ex = e;
        }
        verify(ex != null);
        ...
        ex = null;
        try {
            l = (Long) l.decodeString("0x10000000000000000");
        } catch (Exception e) {
            ex = e;
        }
        verify(ex != null);
